        ...
        ?>
            <div class="wrap">
                ...
                <form method="post" action="">
                    ...
                    <?php $ListTable->search_box('Buscar', 'search'); ?>
...
class CFDB7_List_Table extends WP_List_Table
{
    ...
    public function prepare_items()
    {
        ...
        $option       = "your-";
        $option       .= empty( $_REQUEST['DDM'] ) ? false :  esc_sql( $_POST['DDM'] );
        ...
        if ( ! empty($search) ) {
            ...
            $result_form  = $cfdb->get_results("SELECT * FROM $table_name WHERE form_value LIKE '%$search%' AND form_post_id = '$form_post_id' ");
            $totalItems = 0;
            foreach ( $results as $result ) {
                $form_value = unserialize( $result_form->form_value );
                if ($search === $form_value[$option])
                        $totalItems++;
                    }
    ...
    public function get_columns()
    {
        ...
        if( !empty($first_row) ){
            ...
            foreach ($first_row as $key => $value) {
                ...
                if ( sizeof($columns) > 8) break;
            }
            $columns['form-date'] = 'Fecha';
        }
    ...
    private function table_data()
    {
        ...
        foreach ( $results as $result ) {
            ...
            if (($form_value[$option] == $search) || (empty($search))) {
